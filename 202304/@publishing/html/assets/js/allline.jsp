...
<div id="trainMap" draggable="true" >
	...
	<div style="position: absolute;overflow: hidden;" >
		...
		<object id="text2" type="image/svg+xml" data="../../views/subway/svg/2line_text.svg"></object>
	</div>
	<div style="position: absolute;overflow: hidden;" >
	...
	<div id="objdiv1" style="position: absolute;overflow: hidden;" >
		<img id="subwaybg" src="<c:url value='../../views/subway/svg/subway_all_line.svg'/>" style="opacity: 0.1;" >
	</div>
	<div style="position: absolute;overflow: hidden;" >
		<img id="subwaybg" src="<c:url value='../../views/subway/svg/subway_all_text.svg'/>" style="opacity: 0.1;" >
	</div>
</div>
