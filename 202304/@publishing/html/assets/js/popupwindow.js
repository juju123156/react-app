...
(function($, undefined){
    ...
    var _icons = {
        close           : '<i class="mu-icon-img close"></i>',
        collapse        : 'bbbb',
        uncollapse      : 'cccc',
        maximize        : '<i class="mu-icon-img max"></i>',
        unmaximize      : '<i class="mu-icon-img unmax"></i>',
        minimize        : '<i class="mu-icon-img min"></i>',
        resizeHandle    : 'gggg'
    };
    ...
    function _Init(originalTarget, options){
        ...
        var titlebar = $("<div>", {
            class   : "popupwindow_titlebar mu-panel-head"
        })
        .css(_css.titlebar)
        ...
        // Text
        $("<h3>", {
            class   : "popupwindow_titlebar_text mu-title",
            text    : settings.title
        })
        ...
        if (settings.buttons.close) {
            $("<button>", {
                class   : "popupwindow_titlebar_button popupwindow_titlebar_button_close mu-btn mu-btn-icon mu-btn-bg-non"
            })
        ...
        if (settings.buttons.maximize) {
            $("<button>", {
                class   : "popupwindow_titlebar_button popupwindow_titlebar_button_maximize mu-btn mu-btn-icon mu-btn-bg-non"
            })
            .css(_css.titlebar_button)
        ...
        if (settings.buttons.collapse) {
            $("<button>", {
                class   : "popupwindow_titlebar_button popupwindow_titlebar_button_collapse mu-btn mu-btn-icon mu-btn-bg-non"
            })
            .css(_css.titlebar_button)
        ...
        if (settings.buttons.minimize) {
            $("<button>", {
                class   : "popupwindow_titlebar_button popupwindow_titlebar_button_minimize mu-btn mu-btn-icon mu-btn-bg-non"
            })
            .css(_css.titlebar_button)
        ...
        // Content
        var content = $("<div>", {
            class   : "popupwindow_content mu-panel-body"
        })
        .css(_css.content)
        .appendTo(popupWindow);
